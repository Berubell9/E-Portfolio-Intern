                    ...
                    <Card style={{ width: '100%' }}>
                        <Card.Body>
                            ...
                            <h5 className='text-center'>
                                ...
                                <Badge bg="dark" className="ms-2 mt-2"><FaDatabase /> SQL</Badge>
                                <Badge bg="dark" className="ms-2"><RiJavaLine /> Java</Badge>
                                <Badge bg="dark" className="ms-2 mt-2"><FaPython /> Python</Badge>
                    ...
                    <Card style={{ width: '100%' }}>
                        <Card.Body>
                            ...
                            <h5 className='text-center'>
                                ...
                                <Badge bg="dark" className="ms-2 mt-2"><RiTailwindCssFill /> Tailwind CSS</Badge>
                                <Badge bg="dark" className="ms-2"><FaNode /> Node.js</Badge>
                                <Badge bg="dark" className="ms-2 mt-2"><SiDjango /> Django</Badge>
                            </h5>
                        </Card.Body>
                    </Card>
                    <br />
                    ...
                    <Card style={{ width: '100%' }}>
                        <Card.Body>
                            ...
                            <h5 className='text-center'>
                                ...
                                <Badge bg="dark" className="ms-2 mt-2"><SiXampp /> Xampp</Badge>
                                <Badge bg="dark" className="ms-2 mt-2"><SiMysql /> MySQL</Badge>
                                <Badge bg="dark" className="ms-2 mt-2"><SiMongodb /> MongoDB</Badge>
                            </h5>
                        </Card.Body>
                    </Card>
                    <br />
